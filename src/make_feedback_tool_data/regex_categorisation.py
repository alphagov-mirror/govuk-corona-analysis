...
def regex_category_identification(text: str, dict_category: Dict[str, str]) -> str:
    ...
    :param text: A text string for category identification; the text case is ignored.
    :param dict_category: A dictionary where the keys are possible categories, and the values are regular expression
        patterns that match said category.
    :return: A string of the category from the keys of `dict_category`, or 'unknown' if no matching categories exist.
    """
...
def regex_for_theme(text: str, dict_themes: Optional[Dict[str, str]] = None) -> str:
    ...
    :param text: A text string for theme identification; the text case is ignored.
    :param dict_themes: A dictionary where the keys are possible themes, and the values are regular expression patterns
        that match said theme.
    :return: A string of the theme from the keys of `dict_theme`, or 'unknown' if no matching themes exist.
    """
...
def regex_group_verbs(text: str, dict_group_verbs: Optional[Dict[str, str]] = None) -> str:
    ...
    :param text: A text string for theme identification; the text case is ignored.
    :param dict_group_verbs: A dictionary where the keys are possible verb groupings, and the values are regular
        expression patterns that match said verb grouping.
    :return: A string of the verb grouping from the keys of `dict_group_verbs`, or 'unknown' if no matching verb
        groupings exist.
    """
